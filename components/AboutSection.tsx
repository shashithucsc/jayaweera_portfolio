        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <div className="glass-strong rounded-3xl p-8 hover:glow-primary transition-all duration-300">
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                Hello! I&apos;m Devindi Uthapala
              </h3>
              <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
                <p>
                  I&apos;m a passionate BSc. Computer Science and Technology undergraduate at Uwa Wellassa University with a strong 
                  focus on Cyber Security and Full Stack Development. I love building secure, elegant, and optimized digital experiences 
                  with strong attention to UI/UX.
                </p>
                <p>
                  My journey in tech is driven by a deep interest in securing digital landscapes. I am actively seeking a Cyber Security 
                  internship to apply practical knowledge in threat detection, vulnerability assessment, secure coding, and system hardening.
                </p>
                <p>
          ...
          >
            {[
              ...
              { number: '9As', label: 'O/L Results' },
              { number: 'ABB', label: 'A/L Results' },
            ].map((stat, index) => (
              <motion.div
                key={stat.label}
