    ...
    >
      ...
      >
        <div className="space-y-4 md:space-y-6">
          ...
          >
            <span className="gradient-text">Devindi Uthapala</span>
          </motion.h1>
          ...
          >
            <h2 className="text-lg md:text-2xl lg:text-3xl font-semibold text-gray-300">
              BSc. Computer Science and Technology | Cyber Security & Full Stack Development
            </h2>
            <p className="text-sm md:text-lg text-gray-400 max-w-2xl mx-auto">
              Passionate Computer Science undergraduate specializing in Cyber Security, Digital Forensics, Secure Software Development, and Modern Web Technologies. 
            </p>
          </motion.div>
